...
var _GoodsItem = __webpack_require__(28);
...
var ShoppingCart = function (_Component) {
  ...
  function ShoppingCart() {
    ...
    _this.state = {
      goods: [{ id: 10001, name: 'Mac-air', price: 6000, amount: 1 }, { id: 10002, name: 'Mac-pro', price: 5000, amount: 1 }, { id: 10003, name: 'Mac-book', price: 7000, amount: 1 }, { id: 10004, name: 'Mac', price: 6000, amount: 1 }]
    };
    return _this;
  }
  ...
  _createClass(ShoppingCart, [{
    ...
    value: function getTotal() {
      ...
      * */
      var arr = this.state.goods;
      var total = arr.reduce(function (prev, next, index, arr) {
    ...
    value: function setAmount(id, amount) {
      this.setState({
        goods: this.state.goods.map(function (item) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          Object.keys(goods[0]).concat('Total').map(function (item, i) {
            return _react2.default.createElement(
              'span',
        ...
        goods.map(function (goodsItem, i) {
          return _react2.default.createElement(_GoodsItem2.default, { item: goodsItem, setAmount: _this2.setAmount.bind(_this2), key: i });
        }),
        _react2.default.createElement(
          'div',
          { className: 'total' },
...
var GoodsItem = function (_Component) {
  _inherits(GoodsItem, _Component);

  function GoodsItem(props) {
    _classCallCheck(this, GoodsItem);

    return _possibleConstructorReturn(this, (GoodsItem.__proto__ || Object.getPrototypeOf(GoodsItem)).call(this, props));
  }
  ...
  _createClass(GoodsItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'goodsItem', style: { width: '100%', height: '50px' } },
        _react2.default.createElement(
          'span',
          { className: 'id cell' },
          item.id
